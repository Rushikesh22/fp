...
'./blas2_tpmv_gains_avx512.txt' index 0 using (0.70+0.15*column(0)):(8+$3):4 with errorlines linestyle 7 lw 2 lc 7 ps 0.7 axes x1y2 title '\small gain over MKL', \
'./blas2_tpmv_gains_avx512.txt' index 0 using (0.70+0.15*column(0)):(8+$3):4 with errorlines linestyle 7 lw 0 lc rgb '#FFFFFF' ps 0.0 axes x1y2 title '\textsl{\small reference ($\textsl{FP}_\textsl{\tiny 11,52}$)}', \
'./blas2_tpmv_gains_avx512.txt' index 0 using (0.70+0.15*column(0)):(8+$3):4 with errorlines linestyle 7 lw 2 lc 7 ps 0.7 axes x1y2 notitle, \
